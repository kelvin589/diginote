...
class _AddScreenPopupState extends State<AddScreenPopup> {
  ...
  void _okPressed() {
    ScreenPairing partialScreenPairing = ScreenPairing(pairingCode: _pairingCodeController.text, paired: false, name: _nameController.text, userID: "", lastUpdated: DateTime.now(), screenToken: "", width: 0, height: 0,);
